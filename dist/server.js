...
const zones = [
    // Mumbai
    { id: "Bandra-Kurla Complex", gvs: 91, flags: ["Appreciating", "Undervalued"], staleOffset: 0 },
    { id: "Andheri-West", gvs: 82, flags: ["Appreciating"], staleOffset: 0 },
    { id: "Powai", gvs: 67, flags: [], staleOffset: 0 },
    { id: "Thane-West", gvs: 74, flags: ["Undervalued"], staleOffset: 0 },
    { id: "Navi Mumbai", gvs: 78, flags: ["Appreciating"], staleOffset: 0 },
    { id: "Chembur", gvs: 61, flags: [], staleOffset: 0 },
    { id: "Borivali-North", gvs: 55, flags: ["Appreciating"], staleOffset: 0 },
    { id: "Kurla", gvs: 44, flags: ["Undervalued"], staleOffset: 2 * 24 * 60 * 60 * 1000 },
    // Delhi NCR
    { id: "Gurugram-Sector-54", gvs: 88, flags: ["Appreciating"], staleOffset: 0 },
    { id: "Noida-Sector-62", gvs: 76, flags: ["Appreciating", "Undervalued"], staleOffset: 0 },
    { id: "Dwarka-Expressway", gvs: 83, flags: ["Appreciating"], staleOffset: 0 },
    { id: "Greater-Noida-West", gvs: 59, flags: ["Undervalued"], staleOffset: 0 },
    // Bengaluru
    { id: "Whitefield", gvs: 85, flags: ["Appreciating"], staleOffset: 0 },
    { id: "Sarjapur-Road", gvs: 79, flags: ["Appreciating", "Undervalued"], staleOffset: 0 },
    { id: "Hebbal", gvs: 71, flags: ["Appreciating"], staleOffset: 0 },
    { id: "Electronic-City", gvs: 64, flags: [], staleOffset: 0 },
    // Hyderabad
    { id: "Gachibowli", gvs: 87, flags: ["Appreciating"], staleOffset: 0 },
    { id: "Kondapur", gvs: 73, flags: ["Undervalued"], staleOffset: 0 },
    { id: "Miyapur", gvs: 58, flags: [], staleOffset: 0 },
    // Pune
    { id: "Hinjewadi", gvs: 80, flags: ["Appreciating"], staleOffset: 0 },
    { id: "Kharadi", gvs: 69, flags: ["Undervalued"], staleOffset: 0 },
    { id: "Wakad", gvs: 62, flags: [], staleOffset: 0 },
];
